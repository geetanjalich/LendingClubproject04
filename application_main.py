...
if __name__=='__main__':
    ...
    #customers_raw_df=DataReader.read_customers_raw(spark,job_run_env)
    #DataCleaning.clean_customers_raw(spark,customers_raw_df,job_run_env)
    
    loans_raw_df=DataReader.read_loans_raw(spark,job_run_env)
    DataCleaning.clean_loans_raw(spark,loans_raw_df,job_run_env)
    ...
    #DataCleaning.data_cleaning_loans(spark,loansdefaulters_raw_df,job_run_env)
